...
| [**🤖 Cymonic — AI Talent Engine**](https://github.com/Athul-Titus/Talen-Search) &nbsp;[![Live](https://img.shields.io/badge/Live-000000?style=flat-square&logo=vercel&logoColor=white)](talent-search-eight.vercel.app) | React · FastAPI · NVIDIA NIM · Llama 3 (8B & 70B) · Vercel · Render | Replaced keyword-ATS with semantic LLM scoring; multi-format resume ingestion (PDF/DOCX/Images) with OCR; real-time SSE streaming; anti-fraud credibility detector; deployed full-stack |
